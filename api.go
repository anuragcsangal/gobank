...
// Takes handler functions which return an error and converts them into HTTP handle functions so that they can be passed into handleFunc while server is running
